...
```bash
docker exec -it 677e2ef65a60 /bin/bash
```
...
Enter file in which to save the key (/home/rstudio-pm/.ssh/id_ed25519):
Enter passphrase (empty for no passphrase):
Enter same passphrase again:
Your identification has been saved in /home/rstudio-pm/.ssh/id_ed25519.
Your public key has been saved in /home/rstudio-pm/.ssh/id_ed25519.pub.
The key fingerprint is:
SHA256:5ji7C/XD7Mb5geWHinQKr0R295LoMeo2qhiqW4AFHE8 edwardes.s@gmail.com
...
Then add you SSH key to the ssh-agent:
